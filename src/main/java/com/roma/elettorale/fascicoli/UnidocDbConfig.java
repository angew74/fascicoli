...
@EnableJpaRepositories(entityManagerFactoryRef = "entityUnidocManagerFactory",
        basePackages = {"com.roma.elettorale.fascicoli.unidoc.repository"})
public class UnidocDbConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        return builder.dataSource(dataSource).packages("com.roma.elettorale.fascicoli.unidoc.entity").persistenceUnit("unidoc")
                .build();
    }
