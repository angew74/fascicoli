...
/**
 * <p>Classe Java per BaseResultItem complex type.
 * 
 * <p>Il seguente frammento di schema specifica il contenuto previsto contenuto in questa classe.
 * 
 * <pre>
 * &lt;complexType name="BaseResultItem">
 *   &lt;complexContent>
...
@XmlType(name = "BaseResultItem", propOrder = {
    "value",
    "text",
    "description",
    "subType",
...
@XmlSeeAlso({
    SimpleTreeItem.class
})
public class BaseResultItem {

    @XmlElement(name = "Value", namespace = "http://tempuri.org/")
    protected String value;
    @XmlElement(name = "Text", namespace = "http://tempuri.org/")
    protected String text;
    @XmlElement(name = "Description", namespace = "http://tempuri.org/")
    protected String description;
    @XmlElement(name = "SubType", namespace = "http://tempuri.org/")
    protected String subType;
    @XmlElement(name = "Source", namespace = "http://tempuri.org/")
