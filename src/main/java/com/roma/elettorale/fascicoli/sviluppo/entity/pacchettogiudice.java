...
@Entity
@Table(name = "PACCHETTI_GIUDICI")
public class pacchettogiudice {


    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "PACCHETTI_GIUDICI_SEQ")
    @SequenceGenerator(name = "PACCHETTI_GIUDICI_SEQ_ALL", sequenceName = "PACCHETTI_GIUDIDCI_SEQ")
    private Integer id;
